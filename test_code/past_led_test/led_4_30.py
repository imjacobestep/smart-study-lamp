...
warm = [250, 238, 50] 
cool = [255, 255, 255] 
mixed=[(x+y)/2 for (x,y) in zip(warm,cool)]
...
def set_color(time,brightness):
    if "06:00:00" < time <= "17:00:00":
...
while True:
    ...
    lux = sensor.lux
    brithnessup=not GPIO.input(17)
    changecolor=not GPIO.input(27) 
